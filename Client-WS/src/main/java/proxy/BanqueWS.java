    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BanqueServer
     */
    @WebEndpoint(name = "BanqueServerPort")
    public BanqueServer getBanqueServerPort() {
        return super.getPort(new QName("http://WS/", "BanqueServerPort"), BanqueServer.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServerPort")
    public BanqueServer getBanqueServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WS/", "BanqueServerPort"), BanqueServer.class, features);
    }
